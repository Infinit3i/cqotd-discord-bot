let firewallQuestions = [
    ...
    },
    {
      ...
      blank: "xxxxxx xxxxxx",
      review: "<https://www.cloudflare.com/learning/firewall/packet-filtering-firewall/>"
    },
    {
      category: "Firewall",
      question: "What firewall type inspects the full session of network traffic?",
      answer: "Stateful",
      hint: "Tracks session state",
      blank: "xxxxxxxx",
      review: "<https://www.cisco.com/c/en/us/products/security/stateful-firewalls.html>"
    },
    {
      category: "Firewall",
      question: "Which firewall is implemented through software on a host device?",
    ...
    {
      category: "Firewall",
      question: "What type of firewall is placed between the internal and external network?",
      answer: "Perimeter",
      hint: "Outer boundary",
      blank: "xxxxxxxxx",
      review: "<https://www.fortinet.com/resources/cyberglossary/perimeter-firewall>"
    },
    {
      category: "Firewall",
      ...
      blank: "xxx/xxx",
      review: "<https://www.cloudflare.com/learning/security/threat-detection/intrusion-detection-and-prevention/>"
    },
    {
      category: "Firewall",
      question: "What firewall layer filters traffic based on application protocols?",
      answer: "Layer 7",
      hint: "Application layer",
      blank: "xxxxx x",
      review: "<https://www.cloudflare.com/learning/ddos/glossary/application-layer-7/>"
    },
    {
      category: "Firewall",
      ...
      blank: "xxx",
      review: "<https://www.cisco.com/c/en/us/solutions/small-business/resource-center/nat.html>"
    },
    {
      category: "Firewall",
      ...
      review: "<https://www.trendmicro.com/vinfo/us/security/definition/unified-threat-management>"
    },
    {
      category: "Firewall",
    ...
    {
      category: "Firewall",
      question: "What type of firewall uses machine learning for threat detection?",
      answer: "AI firewall",
      hint: "Uses AI",
      blank: "xx xxxxxxx",
    ...
    {
      category: "Firewall",
      question: "What type of firewall combines stateful and application inspection?",
      answer: "Next-gen",
      hint: "Modern firewall",
      blank: "xxxx-xxx",
      review: "<https://www.cisco.com/c/en/us/products/security/firewalls/what-is-a-next-generation-firewall.html>"
    },
    {
      category: "Firewall",
      question: "Which firewall configuration blocks all incoming connections by default?",
      answer: "Whitelist",
    ...
    },
    {
      ...
      blank: "xxx",
      review: "<https://www.cisco.com/c/en/us/solutions/enterprise-networks/what-is-qos.html>"
    },
    {
      category: "Firewall",
      ...
      review: "<https://www.kaspersky.com/resource-center/definitions/penetration-testing>"
    },
    {
      category: "Firewall",
      ...
      hint: "Bypass rules",
      blank: "xxxxxxxxx",
      review: "<https://www.cloudflare.com/learning/security/glossary/tunneling/>"
    },
    {
      category: "Firewall",
      ...
      blank: "xxx",
      review: "<https://www.cloudflare.com/learning/security/glossary/what-is-port-443/>"
    },
    {
      category: "Firewall",
      ...
      hint: "File sharing",
      blank: "xxx",
      review: "<https://www.cisco.com/c/en/us/products/security/smb-protocol.html>"
    },
    {
      category: "Firewall",
