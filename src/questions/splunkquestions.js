let splunkquestions = [
    {
      category: "Splunk",
      question: "What is the main configuration file used to control indexing behavior?",
      answer: "indexes.conf",
      hint: "File related to indexes",
      blank: "xxxxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Indexesconf>"
    },
    {
      category: "Splunk",
      ...
      blank: "xxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Propsconf>"
    },
    {
      category: "Splunk",
      question: "Which configuration file is used for regular expression transformations?",
      answer: "transforms.conf",
      hint: "Transformations",
      blank: "xxxxxxxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Transformsconf>"
    },
    {
      category: "Splunk",
      question: "What is the central management component in a distributed Splunk deployment?",
      answer: "deployer",
      hint: "Manages configurations",
      blank: "xxxxxxxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/DistSearch/Aboutthedeployer>"
    },
    {
      category: "Splunk",
      question: "Which component is responsible for running searches and presenting results?",
      answer: "search head",
      hint: "Searches and results",
      blank: "xxxxxx xxxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/DistSearch/Aboutdistributedsearch>"
    },
    {
      category: "Splunk",
      ...
      hint: "Indexes data",
      blank: "xxxxxxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Indexer/Abouttheindexer>"
    },
    {
      category: "Splunk",
      ...
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Indexer/Aboutclusteredindexing>"
    },
    {
      category: "Splunk",
    ...
    {
      category: "Splunk",
      question: "Which search command is used to perform fast statistical analysis?",
      answer: "tstats",
    ...
    },
    {
      ...
      blank: "xxxxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Limitsconf>"
    },
    {
      category: "Splunk",
      question: "Which configuration file controls metadata and access permissions?",
      answer: "authorize.conf",
      hint: "Access permissions",
      blank: "xxxxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Authorizeconf>"
    },
    {
      category: "Splunk",
      ...
      hint: "Sends data",
      blank: "xxxxxxxxx",
      review: "<https://docs.splunk.com/Documentation/Forwarder/latest/Forwarder/Abouttheforwarder>"
    },
    {
      category: "Splunk",
      ...
      hint: "Input settings",
      blank: "xxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Inputsconf>"
    },
    {
      category: "Splunk",
      ...
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Updating/Aboutdeploymentserver>"
    },
    {
      category: "Splunk",
    ...
    },
    {
      ...
      blank: "xxxxxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/SearchReference/Report>"
    },
    {
      category: "Splunk",
    ...
    },
    {
      ...
      blank: "xxxxxxxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Distsearchconf>"
    },
    {
      category: "Splunk",
      question: "What is the name of Splunk’s main configuration file for alerts?",
      answer: "savedsearches.conf",
      hint: "Saves searches",
      blank: "xxxxxxxxxxxxx.xxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Savedsearchesconf>"
    },
    {
      category: "Splunk",
      ...
      blank: "xxx xxxxxx",
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Indexer/Aboutsplunkbuckets>"
    },
    {
      category: "Splunk",
    ...
    },
    {
      ...
      review: "<https://docs.splunk.com/Documentation/Splunk/latest/Admin/Addforwardserver>"
    },
  ];
